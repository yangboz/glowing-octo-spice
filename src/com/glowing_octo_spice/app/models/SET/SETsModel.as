...
package com.glowing_octo_spice.app.models.SET
{
	//--------------------------------------------------------------------------
	//
	// Imports
	//
	//--------------------------------------------------------------------------
	import com.glowing_octo_spice.app.consts.COLORs;
	import com.glowing_octo_spice.app.consts.FlexGlobals;
	import com.glowing_octo_spice.app.consts.NUMBERs;
	import com.glowing_octo_spice.app.consts.SHADINGs;
	import com.glowing_octo_spice.app.consts.SYMBOLs;
