	...
	{ 
		...
		override protected function initialize():void
		{
			...
			this._buttonGroup.dataProvider = new ListCollection(
				[
					{ label: "Single Player", triggered: s_play_button_triggeredHandler},
					{ label: "Multiplayer", triggered: m_play_button_triggeredHandler },
					{ label: "View Intro", triggered: intro_button_triggeredHandler },
					{ label: "Credits", triggered: credits_button_triggeredHandler }
				]);
		...
		//
		private function intro_button_triggeredHandler(event:Event):void
		{
		...
		//
		private function credits_button_triggeredHandler(event:Event):void
		{
//			FlexGlobals.screenNavigator.showScreen(FlexGlobals.SCREEN_GAME);
		}
	}
