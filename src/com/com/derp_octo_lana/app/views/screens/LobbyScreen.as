package com.com.derp_octo_lana.app.views.screens
{
	//--------------------------------------------------------------------------
	//
	//  Imports
	...
	import com.com.derp_octo_lana.app.views.popups.AnewGameIndicatory;
	import com.com.derp_octo_lana.app.views.popups.EnterUpIndicatory;
...
//				var label:String = room.data.name +","+room.onlineUsers.toString() + " players";
				...
				roomArrary.push( { label: label, texture: FlexGlobals.iconAtlas.getTexture("TABLE"), roomID:room.id, players:room.onlineUsers } );
