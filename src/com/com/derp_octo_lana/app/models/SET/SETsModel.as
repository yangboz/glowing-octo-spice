...
package com.com.derp_octo_lana.app.models.SET
{
	//--------------------------------------------------------------------------
	//
	// Imports
	//
	//--------------------------------------------------------------------------
	import com.com.derp_octo_lana.app.consts.COLORs;
	import com.com.derp_octo_lana.app.consts.FlexGlobals;
	import com.com.derp_octo_lana.app.consts.NUMBERs;
	import com.com.derp_octo_lana.app.consts.SHADINGs;
	import com.com.derp_octo_lana.app.consts.SYMBOLs;
...
//		public static const ICONS_XML:Class;
		...
		public function SETsModel()
		{
			super();
			//
			FlexGlobals.iconAtlas = new TextureAtlas(Texture.fromBitmap(new EmbedAssets.ICONS_IMAGE(), false), XML(new EmbedAssets.ICONS_XML()));
			//
